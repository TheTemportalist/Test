...
import test.tardis.common.item.ItemPlacer
import test.tardis.server.CommandTardis
...
object Tardis extends ModWrapper {
	...
	final val clientProxy = "test.tardis.client.ProxyClient"
	final val serverProxy = "test.tardis.server.ProxyServer"
